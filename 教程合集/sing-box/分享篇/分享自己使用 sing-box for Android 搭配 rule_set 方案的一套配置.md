{
  ...
  "dns": {
    ...
    "rules": [
      ...
      { "clash_mode": "Direct", "query_type": [ "A" ], "server": "dns_direct" },
      { "clash_mode": "Global", "query_type": [ "A" ], "server": "dns_proxy" },
      { "rule_set": [ "ads" ], "server": "dns_block", "disable_cache": true, "rewrite_ttl": 0 },
      { "rule_set": [ "proxy" ], "query_type": [ "A" ], "server": "dns_fakeip", "rewrite_ttl": 0 },
      { "rule_set": [ "cn" ], "query_type": [ "A" ], "server": "dns_direct" },
  ...
  "outbounds": [
    ...
    { "tag": "🪟 微软服务", "type": "selector", "outbounds": [ "🎯 全球直连", "🚀 节点选择", "🇸🇬 新加坡节点", "🇺🇸 美国节点" ] },
    { "tag": "🇬 谷歌服务", "type": "selector", "outbounds": [ "🎯 全球直连", "🚀 节点选择" ] },
    { "tag": "🍎 苹果服务", "type": "selector", "outbounds": [ "🎯 全球直连", "🚀 节点选择" ] },
    { "tag": "🇨🇳 直连域名", "type": "selector", "outbounds": [ "🎯 全球直连", "🚀 节点选择" ] },
    { "tag": "🇨🇳 直连 IP", "type": "selector", "outbounds": [ "🎯 全球直连", "🚀 节点选择" ] },
    { "tag": "🪜 代理域名", "type": "selector", "outbounds": [ "🚀 节点选择", "🎯 全球直连" ] },
    { "tag": "📲 电报消息", "type": "selector", "outbounds": [ "🚀 节点选择", "🇸🇬 新加坡节点" ] },
    ...
    { "tag": "🇹🇼 台湾节点", "type": "urltest", "tolerance": 50, "use_all_providers": true, "includes": [ "台湾" ] },
  ...
  "outbound_providers": [
    {
      ...
      "type": "remote",
      // 修改为你的 Clash 订阅链接
      "download_url": "https://substore.18306866.xyz/wke9yjndyemrwWJV/download/collection/%E5%A4%9C%E7%85%9E%E4%BA%91_Hysteria2?target=Clash",
      "path": "./airport.yaml",
